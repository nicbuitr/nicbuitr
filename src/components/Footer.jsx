  ...
  render() {
    ...
    return (
      <section className="footer container">
        <p>Find me:</p>
        <a href="https://github.com/nicbuitr" target="_blank"><i className="fa fa-github fa--36 fa--opacity"></i></a>
        <a href="https://www.linkedin.com/in/nicolasbuitrago/" target="_blank"><i className="fa fa-linkedin fa--36 fa--opacity"></i></a>
        <p>Powered by <a href="https://www.w3schools.com/w3css/default.asp" target="_blank">w3.css</a> <br /> &copy; {new Date().getFullYear()} {copy}</p>
